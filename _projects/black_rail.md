...
img: assets/img/blra/BLRA_sonogram.png
importance: 3
category: Ecology
---
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/blra/WindmillPrairie.JPG" title="Windmill Prairie site" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/blra/UnimprovedLZinBackcountry.jpg" title="Backcountry LZ" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/blra/TurnerRiver.JPG" title="Turner River site" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
...
<div class="row justify-content-sm-center">
    <div class="col-sm-8 mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/blra/ARUinfield.JPG" title="ARU in the field" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm-4 mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/blra/DeployingARU.jpeg" title="Deploying an ARU" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
